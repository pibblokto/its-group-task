...
variable "logging_include_cookies" {
    description = "Whether to include cookies into logs"
    type        = bool
    default     = false
}

variable "logging_bucket" {
    description = "Bucket to store logs in"
    type        = string
    default     = ""
}
...
variable "default_allowed_methods" {
    descirption = "List of allowed HTTP methods"
    type        = list(string)
    default     = [""]
}

variable "default_cashed_methods" {
    descirption = "Controls whether CloudFront caches the response to requests using the specified HTTP methods"
    type        = list(string)
    default     = [""]
}

variable "origin_id" {
    descirption = "Unique identifier for the origin"
    type        = string
    default     = ""
}

variable "default_cookies_forward" {
    descirption = "Whether you want CloudFront to forward cookies to the origin that is associated with this cache behavior"
    type        = string
    default     = "none"
}
